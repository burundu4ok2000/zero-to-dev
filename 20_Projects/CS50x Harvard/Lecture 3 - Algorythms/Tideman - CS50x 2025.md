---
title: "Tideman - CS50x 2025"
source: "https://cs50.harvard.edu/x/psets/3/tideman/#tideman"
author:
published:
created: 2025-08-16
...
![Five ballots, tie betweeen Alice and Bob](https://cs50.harvard.edu/x/psets/3/fptp_ballot_1.png)

A plurality vote would here declare a tie between Alice and Bob, since each has two votes. But is that the right outcome?

There’s another kind of voting system known as a ranked-choice voting system. In a ranked-choice system, voters can vote for more than one candidate. Instead of just voting for their top choice, they can rank the candidates in order of preference. The resulting ballots might therefore look like the below.

![Five ballots, with ranked preferences](https://cs50.harvard.edu/x/psets/3/ranked_ballot_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/psets/3/condorcet_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/psets/3/condorcet_graph_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/psets/3/no_condorcet_1.png)
...
To do this, the Tideman algorithm must be careful not to create loops in the candidate graph. How does it do that? It locks in the strongest matches first because those are the most important. The algorithm adds each match one at a time, starting with the one with the most votes. If adding a match does not create a loop, it is added. If it would create a loop, it is ignored.

How does this work with the votes above? The biggest win is Alice beating Bob. Seven voters like Alice more than Bob. No other match has more than 7 voters. So, the arrow from Alice to Bob is added first. The next biggest win is Charlie beating Alice, with 6 voters for Charlie and 3 for Alice. So, that arrow is added next.
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/psets/3/lockin.png)
